        ...
        <div>
            <div className="relative z-0 w-full mb-6 group bg-transparent">
                <input onChange={onChange} onBlur={onBlur} value={value}
                    type={type} name={name} id={id} readOnly={save} className={`${save === true ? "cursor-no-drop bg-[#dddddd] rounded-sm" : " focus:border-blue-600"}  block py-1.5  w-full text-lg pl-2 text-gray-900 border-0 border-b-2 border-gray-300 dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0  peer`} placeholder=" " />
